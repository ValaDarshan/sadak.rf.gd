...
/*------------------------------------------
  ...
  function initGsapParallax() {
    ...
    $('.tp-payment-select .cardPayment').on('click', function(){
    $('.payment-name').addClass('active');
    $('.tp-payment-option').removeClass('active');
    $('.netBank').removeClass('active');
    })


    $('.tp-payment-select .upiPayment').on('click', function(){
        $('.tp-payment-option').addClass('active');
        $('.payment-name').removeClass('active');
        $('.netBank').removeClass('active');
    });

    $('.tp-payment-select .netBanking-payment').on('click', function(){
        $('.tp-payment-option').removeClass('active');
        $('.payment-name').removeClass('active');
        });
